...
trait Presentation {
  ...
  val dominantBaseline = PropertyAttribute[String]("dominant-baseline", null)
  val enableBackground = PropertyAttribute[String]("enable-background", null)
  val fill = PropertyAttribute[Color]("fill", null)
  val fillOpacity = PropertyAttribute[String]("fill-opacity", null)
  ...
  val imageRendering = PropertyAttribute[String]("image-rendering", null)
  ...
  val stroke = PropertyAttribute[Color]("stroke", null)
