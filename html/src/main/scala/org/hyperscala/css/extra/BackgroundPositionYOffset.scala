 ...
 */
class BackgroundPositionYOffset(ss: StyleSheetBase) extends Property[Length]()(ss, implicitly[Manifest[Length]]) with DerivedProperty[Length, BackgroundPosition] {
