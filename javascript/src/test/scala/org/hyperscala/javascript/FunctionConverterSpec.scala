 ...
 */
class FunctionConverterSpec extends Specification {
  "FunctionConverter with different returns" should {
    "properly return Boolean of true" in {
      ...
      cleanScript(script) must_== ("function test() {var x = 1;return x;}")
    }
    "properly return Boolean of false" in {
      ...
      cleanScript(script) must_== ("function test() {var x = 0;return x;}")
    }
    "properly return Int for const range" in {
      ...
      cleanScript(script) must_== ("function test() {var x = 4;return x;}")
    }
    "properly return Int for higher range" in {
      ...
      cleanScript(script) must_== ("function test() {var x = 400;return x;}")
    }
    "property return Int without a variable" in {
      val script = FunctionConverter.f0("test", () => {
        5
      })
      cleanScript(script) must_== ("function test() {return 5;}")
    }
    ...
    "properly return Float for const range" in {
      ...
      cleanScript(script) must_== ("function test() {var x = 1.0;return x;}")
    }
    "properly return Float for higher range" in {
      ...
      cleanScript(script) must_== ("function test() {var x = 400.0;return x;}")
    }
    ...
    "properly return String with a variable" in {
      ...
      cleanScript(script) must_== ("function test() {var x = 'Hello';return x;}")
    }
    "properly return String without a variable" in {
      val script = FunctionConverter.f0("test", () => {
        "Hello"
      })
      cleanScript(script) must_== ("function test() {return 'Hello';}")
    }
  }
  "FunctionConverter with different args" should {
    ...
    "properly invoke with Boolean, String, Int, and Double argument" in {
      ...
      cleanScript(script) must_== ("function test(b, s, i, d) {return i;}")
    }
  }
  "FunctionConverter with conditionals" should {
    "properly invoke with if equals" in {
      ...
      cleanScript(script) must_== ("function test(i) {if (i == -1) {return 0;} else {return i;}}")
    }
  }
