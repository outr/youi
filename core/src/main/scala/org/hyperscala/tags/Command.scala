...
class Command extends Tag {
  ...
  val icon = WebAttribute[String]("icon")
  val label = WebAttribute[String]("label")
  val radioGroup = WebAttribute[String]("radiogroup")
  val commandType = WebAttribute[String]("type")
}
