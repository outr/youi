...
class ContentEditorExample(site: Website[MapSession]) extends Example {
  ...
  val editorPage = new EditablePageExample(site)
...
class EditablePageExample(site: Website[MapSession]) extends Webpage[MapSession](site) {
  ...
  val div = new tag.Div(id = "editor") {
    ...
    contents += new tag.P(content = "This is an example of the <span class=\"editable-color\" style=\"color: red;\">ContentEditor</span> module functionality to assist editing content in-page.")
