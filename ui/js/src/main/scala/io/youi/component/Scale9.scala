...
class Scale9 extends AbstractContainer {
  override type Child = TextureComponent
  ...
  private val topLeft = new TextureComponent {
    position.left := 0.0
    position.top := 0.0
    size.width := x1
    size.height := y1
  ...
  private val top = new TextureComponent {
    position.left := x1
    position.top := 0.0
  ...
  private val topRight = new TextureComponent {
  ...
  private val left = new TextureComponent {
    position.left := 0.0
    position.top := y1
    size.width := x1
  ...
  private val center = new TextureComponent {
    position.left := x1
    position.top := y1
    size.width := centerWidth
    size.height := middleHeight
  ...
  private val right = new TextureComponent {
    position.right := Scale9.this.size.width
    position.top := y1
    size.width := rightWidth
    size.height := middleHeight
  ...
  private val bottomLeft = new TextureComponent {
    position.left := 0.0
  ...
  private val bottom = new TextureComponent {
    position.left := x1
    position.bottom := Scale9.this.size.height
    size.width := centerWidth
    size.height := bottomHeight
  ...
  private val bottomRight = new TextureComponent {
    position.right := Scale9.this.size.width
    position.bottom := Scale9.this.size.height
    size.width := rightWidth
    size.height := bottomHeight
