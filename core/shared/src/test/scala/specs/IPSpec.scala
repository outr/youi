  ...
  "IP" when {
    ...
    "parsing IPv6 addresses" should {
      ...
      "properly parse 2604:ca00:129:99af::860:930a" in {
        ...
        ip.parts should be(Vector(9732, 51712, 297, 39343, 0, 0, 2144, 37642))
